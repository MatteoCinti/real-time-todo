...
export type ListenTodoUpdatedSubscription = { __typename?: 'Subscription', todoUpdated: { __typename?: 'Todo', id: number, title: string, description?: string | null, isDone: boolean } };
